...
if exist "%~dp0..\examples\v24_problem_solving_exercises" xcopy "%~dp0..\examples\v24_problem_solving_exercises" "%RELEASE_DIR%\examples\v24_problem_solving_exercises\" /E /I /Y
