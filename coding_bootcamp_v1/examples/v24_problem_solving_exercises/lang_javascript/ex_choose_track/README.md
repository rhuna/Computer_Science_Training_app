# Choose a 90-Day Professional Track - JavaScript

Exercise id: `ex_choose_track`
...
4. Keep the same behavior and make the program print `PASS_CHOOSE_TRACK` after the solution succeeds.
