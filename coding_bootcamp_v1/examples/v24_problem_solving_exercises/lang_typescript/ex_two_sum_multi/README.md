# Two Sum in Multiple Languages - TypeScript

Exercise id: `ex_two_sum_multi`
...
4. Keep the same behavior and make the program print `PASS_TWO_SUM_MULTI` after the solution succeeds.
