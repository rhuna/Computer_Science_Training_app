# Capstone Pitch Document - TypeScript

Exercise id: `ex_capstone_pitch`
...
4. Keep the same behavior and make the program print `PASS_CAPSTONE_PITCH` after the solution succeeds.
