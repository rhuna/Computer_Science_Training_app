# Input Validator - TypeScript

Exercise id: `ex_input_validator`
...
4. Keep the same behavior and make the program print `PASS_INPUT_VALIDATOR` after the solution succeeds.
