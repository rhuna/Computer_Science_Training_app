# Release Checklist - Kotlin

Exercise id: `ex_release_checklist`

Expected verification token:

```text
PASS_RELEASE_CHECKLIST
```
...
4. Keep the same behavior and make the program print `PASS_RELEASE_CHECKLIST` after the solution succeeds.
