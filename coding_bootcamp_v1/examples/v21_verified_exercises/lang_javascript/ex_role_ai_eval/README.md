# AI Answer Evaluation Drill - JavaScript

Exercise id: `ex_role_ai_eval`
...
4. Keep the same behavior and make the program print `PASS_ROLE_AI_EVAL` after the solution succeeds.
