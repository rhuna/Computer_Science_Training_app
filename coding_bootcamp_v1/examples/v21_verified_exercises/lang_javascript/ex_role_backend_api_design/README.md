# Backend API Design Review - JavaScript

Exercise id: `ex_role_backend_api_design`

Expected verification token:

```text
PASS_ROLE_BACKEND_API_DESIGN
```
...
4. Keep the same behavior and make the program print `PASS_ROLE_BACKEND_API_DESIGN` after the solution succeeds.
