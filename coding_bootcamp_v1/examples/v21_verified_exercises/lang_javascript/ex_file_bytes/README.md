# File Byte Inspector - JavaScript

Exercise id: `ex_file_bytes`
...
4. Keep the same behavior and make the program print `PASS_FILE_BYTES` after the solution succeeds.
