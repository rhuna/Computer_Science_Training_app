# Resume Bullet Generator - JavaScript

Exercise id: `ex_resume_bullets`
...
4. Keep the same behavior and make the program print `PASS_RESUME_BULLETS` after the solution succeeds.
