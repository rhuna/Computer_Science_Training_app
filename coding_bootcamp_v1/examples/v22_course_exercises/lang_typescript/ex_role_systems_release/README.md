# C++ Desktop Release Drill - TypeScript

Exercise id: `ex_role_systems_release`

Expected verification token:

```text
PASS_ROLE_SYSTEMS_RELEASE
```
...
4. Keep the same behavior and make the program print `PASS_ROLE_SYSTEMS_RELEASE` after the solution succeeds.
