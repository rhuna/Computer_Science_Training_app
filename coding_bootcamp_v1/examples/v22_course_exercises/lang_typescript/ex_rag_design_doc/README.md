# RAG Design Document - TypeScript

Exercise id: `ex_rag_design_doc`
...
4. Keep the same behavior and make the program print `PASS_RAG_DESIGN_DOC` after the solution succeeds.
