# Design a REST API - JavaScript

Exercise id: `ex_rest_design`
...
4. Keep the same behavior and make the program print `PASS_REST_DESIGN` after the solution succeeds.
