# Frontend State Checklist - JavaScript

Exercise id: `ex_frontend_states`

Expected verification token:

```text
PASS_FRONTEND_STATES
```
...
4. Keep the same behavior and make the program print `PASS_FRONTEND_STATES` after the solution succeeds.
