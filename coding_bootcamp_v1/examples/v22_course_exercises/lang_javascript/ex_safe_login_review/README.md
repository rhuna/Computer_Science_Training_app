# Secure Login Review - JavaScript

Exercise id: `ex_safe_login_review`

Expected verification token:

```text
PASS_SAFE_LOGIN_REVIEW
```
...
4. Keep the same behavior and make the program print `PASS_SAFE_LOGIN_REVIEW` after the solution succeeds.
