# Refactor a God Class - TypeScript

Exercise id: `ex_arch_refactor`
...
4. Keep the same behavior and make the program print `PASS_ARCH_REFACTOR` after the solution succeeds.
