# Incident Postmortem - JavaScript

Exercise id: `ex_incident_postmortem`

Expected verification token:

```text
PASS_INCIDENT_POSTMORTEM
```
...
4. Keep the same behavior and make the program print `PASS_INCIDENT_POSTMORTEM` after the solution succeeds.
