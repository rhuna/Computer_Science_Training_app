# Design a Learning Tracker Database - JavaScript

Exercise id: `ex_sql_schema`
...
4. Keep the same behavior and make the program print `PASS_SQL_SCHEMA` after the solution succeeds.
