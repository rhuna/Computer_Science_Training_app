...
private:
    ...
    QString advancedHelperText() const;
    QString currentHelperPhase() const;
    QString helperPopupText(const QString& phase) const;
    QString formatHelperTimer() const;
    ...
    void advanceCourseStage();
    void saveCurrentCourseCheckpoint(const QString& status);
    void refreshHistoryPane();
    void selectHistoryItem(int index);
    void recordProblemSolvingDrill();
    void startHelperTimer();
    void pauseHelperTimer();
    void resetHelperTimer();
    void tickHelperTimer();
    void showHelperPopup();
    void advanceHelperPhase();
    ...
    QLabel* m_helperContextLabel = nullptr;
    QLabel* m_helperTimerLabel = nullptr;
    ...
    QListWidget* m_completedHistoryList = nullptr;
    QStackedWidget* m_courseTaskStack = nullptr;
    QLabel* m_courseStageTitle = nullptr;
    QLabel* m_courseGateLabel = nullptr;
    QTextEdit* m_currentTaskBody = nullptr;
    QTextEdit* m_questionTaskBody = nullptr;
    QTextEdit* m_reviewEditor = nullptr;
    int m_courseStageIndex = 0;
