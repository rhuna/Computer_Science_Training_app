# System Design Drill - JavaScript

Exercise id: `ex_system_design_prompt`

Expected verification token:

```text
PASS_SYSTEM_DESIGN_PROMPT
```
...
4. Keep the same behavior and make the program print `PASS_SYSTEM_DESIGN_PROMPT` after the solution succeeds.
