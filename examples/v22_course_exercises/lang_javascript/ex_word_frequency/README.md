# Word Frequency Counter - JavaScript

Exercise id: `ex_word_frequency`
...
4. Keep the same behavior and make the program print `PASS_WORD_FREQUENCY` after the solution succeeds.
