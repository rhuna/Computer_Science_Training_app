# Refactor Journal - JavaScript

Exercise id: `ex_v15_refactor_journal`

Expected verification token:

```text
PASS_V15_REFACTOR_JOURNAL
```
...
4. Keep the same behavior and make the program print `PASS_V15_REFACTOR_JOURNAL` after the solution succeeds.
