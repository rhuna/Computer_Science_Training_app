# Number Base Converter - TypeScript

Exercise id: `ex_base_converter`
...
4. Keep the same behavior and make the program print `PASS_BASE_CONVERTER` after the solution succeeds.
