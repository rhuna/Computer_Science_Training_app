# Containerization Plan - TypeScript

Exercise id: `ex_docker_plan`
...
4. Keep the same behavior and make the program print `PASS_DOCKER_PLAN` after the solution succeeds.
