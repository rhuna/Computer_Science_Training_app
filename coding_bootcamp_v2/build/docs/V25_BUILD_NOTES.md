...
- Updated progress database filename to `progress_v27.sqlite`.

## Manual QA checklist

1. The app launches and shows the v27 title.
...
8. Exercise Runner still points at `examples/v27_learning_testing_course_exercises`.
